...
def test_real_llm_call():
    ...
    print("=== REAL LLM Test ===\n")
    print("⚠️  This will make an actual API call to Google Gemini!")
    print("⚠️  This will use your API quota and may incur costs.\n")
    ...
    try:
        ...
        if response.success:
            ...
            print(f"\n✅ This output came from REAL Gemini LLM, not hardcoded data!")
            
        else:
            print("❌ REAL LLM call failed!")
