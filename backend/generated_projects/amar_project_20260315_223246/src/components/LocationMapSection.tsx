...
const LocationMapSection: React.FC<LocationMapSectionProps> = ({ address = '', children }) => {
  return (
    <Card sx={{ p: 3, borderRadius: 3, boxShadow: 2, textAlign: 'center' }}>
      <CardContent>
        ...
        <Typography variant="body1" sx={{ mb: 3, color: 'text.secondary', lineHeight: 1.6 }}>
          Location details and map/embed area. - This component provides exceptional functionality with a beautiful, 
