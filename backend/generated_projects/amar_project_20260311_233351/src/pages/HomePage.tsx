      ...
      <Box sx={{
        ...
        <Container maxWidth="lg">
          ...
          <Typography variant="h5" sx={{ mb: 4, opacity: 0.9, maxWidth: '600px', mx: 'auto' }}>
            Main landing page showcasing the coffee shop and its offerings - Transform your experience with our innovative solution that delivers exceptional results and drives success.
          </Typography>
          <Button 
            variant="contained" 
            size="large" 
